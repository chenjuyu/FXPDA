...
public class PrinterCMD {
     ...
     * 字体的大小
     * 
     * @param nfontsize 0:正常大小 1:两倍高 2:两倍宽 3:两倍大小 4:三倍高 5:三倍宽 6:三倍大小 7:四倍高 8:四倍宽 9:四倍大小 10:五倍高
     *        11:五倍宽 12:五倍大小
     * @return
     */
     ...
     * 返回状态(返回8位的二进制)
     * 
     * @param num 1:打印机状态 2:脱机状态 3:错误状态 4:传送纸状态 返回打印机状态如下： 第一位：固定为0 第二位：固定为1 第三位：0:一个或两个钱箱打开
     *        1:两个钱箱都关闭 第四位：0:联机 1:脱机 第五位：固定为1 第六位：未定义 第七位：未定义 第八位：固定为0
     * 
     *        返回脱机状态如下： 第一位：固定为0 第二位：固定为1 第三位：0:上盖关 1:上盖开 第四位：0:未按走纸键 1:按下走纸键 第五位：固定为1 第六位：0:打印机不缺纸
     *        1: 打印机缺纸 第七位：0:没有出错情况 1:有错误情况 第八位：固定为0
     * 
     *        返回错误状态如下： 第一位：固定为0 第二位：固定为1 第三位：未定义 第四位：0:切刀无错误 1:切刀有错误 第五位：固定为1 第六位：0:无不可恢复错误 1:
     *        有不可恢复错误 第七位：0:打印头温度和电压正常 1:打印头温度或电压超出范围 第八位：固定为0
     * 
     *        返回传送纸状态如下： 第一位：固定为0 第二位：固定为1 第三位：0:有纸 1:纸将尽 第四位：0:有纸 1:纸将尽 第五位：固定为1 第六位：0:有纸 1:纸尽
     *        第七位：0:有纸 1:纸尽 第八位：固定为0
     * @return
     */
