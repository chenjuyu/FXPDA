...
public abstract class BarcodeCreater {
     ...
     * @return
     */
    public static Bitmap creatBarcode(Context context, String contents, int desiredWidth, int desiredHeight, boolean displayCode, BarcodeFormat format) {
     ...
     * @return
     */
    public static Bitmap creatTextBitmap(String contents, int width, int height, Context context) {
        TextView tv = new TextView(context);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(width, height);
        tv.setLayoutParams(layoutParams);
        tv.setText(contents);
     ...
     */
    public static Bitmap encode2dAsBitmap(String contents, int desiredWidth, int desiredHeight, BarcodeFormat format) {
        if (format != null) {
            barcodeFormat = format;
        }
        Bitmap barcodeBitmap = null;
