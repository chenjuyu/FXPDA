...
/**
 * Title: BarcodeVerificationDifferentAdapter Description: 条码校验差异ListView适配器
 * 
 * @author LYJ
 * 
 */
public class BarcodeVerificationDifferentAdapter extends BaseAdapter {

    private List<Map<String, Object>> data;
    private LayoutInflater layoutInflater;
    private Context context;

    public BarcodeVerificationDifferentAdapter(Context context, List<Map<String, Object>> data) {
