...
/**
 * Title: BarcodeVerificationAdapter Description: 装箱单ListView适配器
 * 
 * @author LYJ
 * 
 */
public class PackingBoxDetailAdapter extends BaseAdapter {

    private List<Map<String, Object>> data;
    private LayoutInflater layoutInflater;
    private Context context;

    public PackingBoxDetailAdapter(Context context, List<Map<String, Object>> data) {
    ...
    /**
     * Title: Odd Description: 组件集合，对应list_packing_box_detail.xml中的控件
     */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            odd = new Odd();
            // 获得组件，实例化组件
            convertView = layoutInflater.inflate(R.layout.list_packing_box_detail, null);
        ...
        int length2 = Tools.length(quantity);
        if (length2 > 5) {
            odd.docQty.setTextSize(15);
        } else {
            odd.docQty.setTextSize(17);
        }
