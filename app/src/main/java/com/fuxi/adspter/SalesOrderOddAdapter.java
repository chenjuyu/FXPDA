 ...
 * 
 */
public class SalesOrderOddAdapter extends BaseAdapter {

    private List<Map<String, Object>> data;
    private LayoutInflater layoutInflater;
    private Context context;

    public SalesOrderOddAdapter(Context context, List<Map<String, Object>> data) {
    ...
    /**
     * 组件集合，对应activity_sales_order_odd.xml中的控件
     */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            odd = new Odd();
            // 获得组件，实例化组件
            convertView = layoutInflater.inflate(R.layout.activity_sales_order_odd, null);
            ...
            odd.discountPrice = (TextView) convertView.findViewById(R.id.discountPrice);
        ...
        // 折后价
        String discountPrice = String.valueOf(data.get(position).get("DiscountPrice"));
        ...
        odd.discountPrice.setText(discountPrice);
